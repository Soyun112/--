...
DEMO_PLACES: dict[str, tuple[float, float, str]] = {
    "우리집": (37.4995, 127.0370, "우리집 (데모 출발지)"),
    "집": (37.4995, 127.0370, "우리집 (데모 출발지)"),
    "대림역삼아파트": (37.4963209, 127.0464667, "대림역삼아파트"),
    "세모수학": (37.4973826, 127.0547242, "세모수학"),
    "역삼초등학교": (37.4931733, 127.0326026, "역삼초등학교"),
    "OO초등학교": (37.5035, 127.0410, "OO초등학교 (데모 목적지)"),
    "학교": (37.5035, 127.0410, "OO초등학교 (데모 목적지)"),
    "초등학교": (37.5035, 127.0410, "OO초등학교 (데모 목적지)"),
    "OO유치원": (37.4998, 127.0370, "OO유치원 (데모)"),
    "유치원": (37.4998, 127.0370, "OO유치원 (데모)"),
    "학원": (37.5021, 127.0400, "OO학원 (데모)"),
    "OO초등학교 정문": (37.5025, 127.0410, "OO초등학교 정문 (데모)"),
    "OO초등학교 후문": (37.5035, 127.0405, "OO초등학교 후문 (데모)"),
}
