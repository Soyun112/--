...
DEMO_PLACES: dict[str, tuple[float, float, str]] = {
    # 도곡 통학 (발표용 저장 장소 — 표시 라벨은 도로명주소)
    "도곡초등학교": (37.49899, 127.05458, "선릉로64길 33"),
    "도곡초": (37.49899, 127.05458, "선릉로64길 33"),
    "선릉로64길 33": (37.49899, 127.05458, "선릉로64길 33"),
    "개나리래미안아파트": (37.49875, 127.04948, "역삼로 306"),
    "개나리래미안": (37.49875, 127.04948, "역삼로 306"),
    "개나리 래미안": (37.49875, 127.04948, "역삼로 306"),
    "역삼로 306": (37.49875, 127.04948, "역삼로 306"),
    "서울 강남구 역삼로 306": (37.49875, 127.04948, "역삼로 306"),
    "서울특별시 강남구 역삼로 306": (37.49875, 127.04948, "역삼로 306"),
    "게이트대치어학원": (37.49561, 127.05024, "도곡로 313"),
    "게이트대치": (37.49561, 127.05024, "도곡로 313"),
    "도곡로 313": (37.49561, 127.05024, "도곡로 313"),
    "깊은생각수학학원": (37.49859, 127.05902, "도곡로 445"),
    "깊은생각수학": (37.49859, 127.05902, "도곡로 445"),
    "도곡로 445": (37.49859, 127.05902, "도곡로 445"),
    # 기존 데모·테스트 호환
    ...
    "학교": (37.49899, 127.05458, "선릉로64길 33"),
    "초등학교": (37.49899, 127.05458, "선릉로64길 33"),
    "OO유치원": (37.4998, 127.0370, "OO유치원 (데모)"),
    "유치원": (37.4998, 127.0370, "OO유치원 (데모)"),
    "학원": (37.49561, 127.05024, "도곡로 313"),
    ...
    for table, src in ((DEMO_PLACES, "DEMO_DICT"), (STATION_DICT, "STATION_DICT")):
        for candidate in (key, key.rstrip("역"), key + "역", key_lower):
            for table_key, value in table.items():
                tk = table_key.replace(" ", "")
                if tk == candidate or tk.lower() == candidate.lower():
                    lat, lng, label = value
