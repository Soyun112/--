...
// head에서 동기 로드될 때만 document.write 가 동작한다 → jsv2 스텁이 실제 SDK를 붙인다.
let keyJs =
...
console.log(
  "[build-vercel] tmap-key.js →",
  tmapKey ? `TMAP key + sync jsv2 (len=${tmapKey.length})` : "TMAP key empty (set TMAP_APP_KEY on Vercel)"
);
